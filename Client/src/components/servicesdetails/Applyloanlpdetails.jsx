...
const Applyloanlpdetails = () => {
  return (
    <div>
      <h1 class="text-5xl font-bold mb-6 text-center my-10">* Apply Loan Here *</h1>
              ...
              <div className="py-1">
                ...
                <Menu.Item>
                  {({ active }) => (
                    ...
                    <div class="form-group mb-6 my-6">
                      <textarea
                        class="
                form-control
                block
...
export default Applyloanlpdetails;
