...
const Udyam = () => {
    ...
    const [DetailsOfBusinessActivites, setDetailsOfBusinessActivites] = useState(null);
    const [InformationOfTheInvestment, setInformationOfTheInvestment] = useState(null);
    const [InformationOfTheTurnOver, setInformationOfTheTurnOver] = useState(null);
