...
const Business = () => {
    ...
    const [ProofOfContinuationTradeLiscense, setProofOfContinuationTradeLiscense] = useState(null);
    const [ProofOfContinuationEstablishment, setProofOfContinuationEstablishment] = useState(null);
    const [ProofOfContinuationSalesTax, setProofOfContinuationSalesTax] = useState(null);
    ...
    const [TrueCopyArticleofAssociation, setTrueCopyArticleofAssociation] = useState(null);
    ...
    const handleLeadForm = async (e) => {
      ...
      formData.append("ProofOfContinuationEstablishment", ProofOfContinuationEstablishment);
      formData.append("ProofOfContinuationTradeLiscense", ProofOfContinuationTradeLiscense);
      formData.append("ProofOfContinuationSalesTax", ProofOfContinuationSalesTax);
      ...
      formData.append("TrueCopyArticleofAssociation", TrueCopyArticleofAssociation);
