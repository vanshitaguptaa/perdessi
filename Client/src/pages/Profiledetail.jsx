...
const Profiledetail = ({ Profiledata }) => {
  const url = "https://i0.wp.com/www.society19.com/wp-content/uploads/2020/04/pinterest__tbhjessica-%E2%98%BC-%E2%98%BE%E2%99%A1.png?w=1024&ssl=1"
          ...
          <div className="grid grid-rows-2 pt-8 pl-10 h-full bg-gradient-to-br from-cyan-300 via-cyan-400 to-gray-200">
              <div className="backdrop-blur-md grid gap-24 grid-cols-2">
                <div className="grid gap-4 grid-cols-2">
                  ...
                  ></img>
                  <div>
                    <h3 className="font-bold text-2xl uppercase">{Profiledata.first_name}  {Profiledata.last_name}</h3>
                    <p className="font-bold uppercase">{Profiledata.role}</p>
                    <p className="font-semibold">Team: {Profiledata.Team}</p>
                    <p className="font-semibold">Date of Joining: {change_into_date(Profiledata.joiningdate)}</p>
                ...
                <div className=" pl-3 h-44">
                  ...
                  <p className="font-semibold">Birthday: {change_into_date(Profiledata.dob)}</p>
              ...
              <div className="backdrop-blur-md extra-information-div -mt-4 pb-4 grid grid-rows-2 grid-cols-2">
                <div className="">
                  <h5 className="font-bold text-2xl uppercase">Personal information</h5>
                ...
                <div className="">
                  <h5 className="font-bold text-2xl uppercase">Emergency Contacts</h5>
                  <div className="grid grid-cols-2">
                    <div>
                    ...
                    <div className="">
                      <p className="font-semibold">{Profiledata.emergencyContactName}</p>
                      <p className="font-semibold">{Profiledata.emergencyContactRelationship}</p>
                      <p className="font-semibold">{Profiledata.EmergencyContactNumber}</p>
                    </div>
                  </div>
                </div>
                <div className="">
                ...
                <div>
                  <button onClick={()=>{navigate(`/update`)}} className="rounded-full bg-violet-500 p-3 text-white font-semibold">Update Profile</button>
                </div>
              </div>
          </div>
        ) : (
