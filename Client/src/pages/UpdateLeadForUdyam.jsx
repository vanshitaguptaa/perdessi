      ...
      <form className="w-full max-w-lg">
        ...
        <div className="flex flex-wrap -mx-3 mb-2">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <p className="cursor-pointer" onClick={() => setAadhar(!adhar)}>
              <GrFormEdit />
            </p>
            {adhar && (
              <>
            ...
            {activites && (
              <>
                ...
                <img
                  ...
                  alt="submit-progress--v2"
                  onClick={(e) => {
                    editUdyamCertificateLead(e, "DetailsOfBusinessActivites");
                  }}
                />
              </>
            )}
            ...
            {investment && (
              <>
                ...
                <img
                  ...
                  alt="submit-progress--v2"
                  onClick={(e) => {
                    editUdyamCertificateLead(e, "InformationOfTheInvestment");
                  }}
                />
              </>
            )}
            ...
            {turnOver && (
              <>
                ...
                <img
                  ...
                  alt="submit-progress--v2"
                  onClick={(e) => {
                    editUdyamCertificateLead(e, "InformationOfTheTurnOver");
                  }}
                />
              </>
            )}
